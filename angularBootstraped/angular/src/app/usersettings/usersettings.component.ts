...
export class UsersettingsComponent {
  ...
  ngOnInit(){
    ...
    if(this.theme.getMode() == "dark"){
      ...
      var darkDiv = this.elementRef.nativeElement.querySelector("#darkModeDiv");
      if(darkDiv){
        darkDiv.innerHTML = "<style>.theme{color:black} .boxCol{background-color:white}";
      }
    }
